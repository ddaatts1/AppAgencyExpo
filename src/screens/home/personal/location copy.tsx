...
//     const [textLocation, setTextLocation] = useState() as any;
...
//         { id: 3, name: '', selectlocation: 'Chọn Phường/ Xã', type: 'Phường/ Xã' }
//     ]);
//     useEffect(() => {
...
//             setId(name.id)
//             setStep(step + index)
//             setTextLocation(dataStep[0].name + ', ' + dataStep[1].name + ', ' + dataStep[1].name)
