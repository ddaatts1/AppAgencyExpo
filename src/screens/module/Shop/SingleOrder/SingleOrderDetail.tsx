...
const SingleOrderDetail = ({route}: any) => {
    ...
    function valueQuantity() {
        ...
        if (quantity === 1) {
            ...
            return             navigation.navigate(ROUTES.SINGLEORDERCONFIRMORDER, {
    ...
    function handleBuy() {
        if (selectedColor && selectedSize) {
            navigation.navigate(ROUTES.SINGLEORDERCONFIRMORDER, {
                item: fetchingCardDetailData?.data,
                quantity: quantity,
                color: selectedColor,
                size: selectedSize
        ...
        <View style={styles.container}>
            {isFetchingCardDetail ? <LoadingReact/> : <>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <ModalPoupFshop visible={addToCart}>
                        <View style={{width: '100%', flexDirection: 'row'}}>
                            ...
                            <View style={{width: '65%', marginLeft: 12}}>
                                <View>
                                    <Text>{fetchingCardDetailData?.data?.product_name}</Text>
                                </View>
                                <View style={styles.price}>
                                    <View style={styles.priceDiscount}>
                                        <SVG.VND color="#525252"/>
                    ...
                    <ModalPoupFshop visible={otherAddToCart}>
                        <View style={{width: '100%', flexDirection: 'row'}}>
                            ...
                            <View style={{width: '65%', marginLeft: 12}}>
                                <View>
                                    <Text>{otherItem?.product_name}</Text>
                                </View>
                                <View style={styles.price}>
                                    <View style={styles.priceDiscount}>
                                        <SVG.VND color="#525252"/>
                ...
                <View style={styles.footer}>
                    ...
                    <View style={{width: '60%'}}>
                        <TouchableOpacity onPress={() => valueQuantity()} style={styles.foot2}>
