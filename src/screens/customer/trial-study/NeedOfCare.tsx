...
const NeedOfCare = (route: any) => {
    ...
    const [isDisplay, setIsDisplay] = useState(slug);
    ...
    useFocusEffect(
        React.useCallback(() => {
            ...
            console.log("takeCarePopup: " + takeCarePopup)
            console.log("isFirstTime: "+ isFirstTime)
            if (isFirstTime){
                setFirstPopup(takeCarePopup)
                isFirstTime= false
            }
            ...
            <View style={styles.container}>
                ...
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <ModalPoup visible={firstPopup}>
                        ...
                        <Text style={{marginVertical: 20, fontSize: 20, textAlign: 'center', color: "#000000"}}>
                            <Text>
                                Đây là danh sách <Text style={{fontWeight: 'bold'}}>khách hàng mới</Text> của bạn.
                            </Text>
                            {"\n"}
                            {"\n"}
                            <Text>
                                Bạn cần chăm sóc để khách hàng để họ cài ứng dụng FutureLang và vào học hàng ngày nhé...
                            </Text>
                        </Text>
                        <TouchableOpacity
                ...
                <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                    <ModalPoup visible={false}>
                        ...
                        <Text style={{marginVertical: 20, fontSize: 20, textAlign: 'center', color: "#009C10"}}>
                            Cập nhật thành công
                        </Text>
                        <TouchableOpacity
