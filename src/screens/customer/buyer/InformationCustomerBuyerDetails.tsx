...
const InformationCustomerBuyerDetails = ({route}:any) => {
                    ...
                    <Formik
                        ...
                        {({ handleSubmit, isValid, values, }) => (
                            <>
                                ...
                                {/*    isValid={true}*/}
                                {/*    component={CustomDropdownDetailsCustomer}*/}
                                {/*    defaultItem={status[customerData?.status_customer-1].name}*/}
                                {/*    name="status"*/}
                                {/*    title="Trạng thái"*/}
                                ...
                                <View style={{ marginBottom: 43, marginTop: 12 }}>
                                    ...
                                    {/*        <Text style={{ color: '#FFFFFF', fontSize: 16, paddingLeft: 10, fontWeight: 500 }}>Xác nhận</Text>*/}
                                    {/*    </View>*/}
                                    {/*</TouchableOpacity>*/}
...
export default InformationCustomerBuyerDetails;
